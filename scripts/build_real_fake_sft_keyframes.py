...
FAKE_NEWS_PROMPT = (
    "Determine whether the news claim or event conveyed by these sampled key frames and the "
    "auxiliary observations is factually real or fake.\n\n"
    "This task is short-video news veracity detection, not deepfake detection. Judge whether the "
    "news conveyed by the frames and associated context is true as stated.\n\n"
    ...
    "Label the sample real if the conveyed news content is factually true and the sampled frames "
